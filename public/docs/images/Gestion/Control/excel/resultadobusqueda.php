...
$local2 = (isset($_POST['local2']) ? $_POST['local2'] : null);
$sem3 = (isset($_POST['sem3']) ? $_POST['sem3'] : null);
$local3 = (isset($_POST['local3']) ? $_POST['local3'] : null);
...
echo '<td>'.$f['asunto'].'</td>';
echo '<td>'.$f['guia'].'</td>';
echo '<td>'.$f['sem']. '&cedil; &nbsp;' .$f['sem1']. '&cedil; &nbsp;' .$f['sem2']. '&cedil; &nbsp;' .$f['sem3'].'</td>';
echo '<td>'.$f['local']. '&cedil; &nbsp;' .$f['local1']. '&cedil; &nbsp;' .$f['local2']. '&cedil; &nbsp;' .$f['local3'].'</td>';
echo '</tr>';
...
$excel.="$f[tema]\t$Date\t$f[remitente2]\t$f[asunto]\t";
$excel.="$f[guia]\t$f[sem]\t$f[local]\n";
