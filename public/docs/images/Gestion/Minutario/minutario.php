  ...
  <tr>    
    <td align="center">Tipo de Documento<br/>
      <select name="tipodocumento">
        ...
        <option value="VALIJA DIPLOMÁTICA">VALIJA DIPLOMÁTICA</option>
...
<option value="Serie03S.09Servicio delegacional">03S.09Servicio delegacional</option>
  ...
  <tr>
    <td align="center">Elaboró del SEM<br/>    
      <select name="sem">
        <option value="">SELECCIONE</option>
    ...
    <td align="center">Elaboró LOCAL<br/>
      <select name="local">
        <option value="">SELECCIONE</option>
  ...
  <tr>
  <td colspan="4" align="right"><input type="button" onclick="document.location.reload();" value="Nuevo" name="http://192.168.39.31/Gestion/minutario/minutario.php" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="Borrar información">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="Guardar" value="Guardar"></td>
  </tr>
...
<?php $host = "localhost";
		 ...
		 $resulta = $con->query($consulta);
		  while($rows=mysqli_fetch_array($resulta)){
			 echo "<br><p style='color:#F00; font-size:18px'><br>Ultimo número tomado FIA $idb </p>";
