...
<title>Busqueda acta de nacimiento</title>
...
<form name="form1" method="GET" action="http://192.168.39.31/intranet/images/RegistroCivil/acta/resultado_actas_nacimiento.php" >

  <tr>
  <th colspan="4"><h2 align="center">B&Uacute;SQUEDA ACTAS DE NACIMIENTO</h2></th>
  </tr>
  <tr>
...
<th align="center">
 <!--- <input type="radio" name="ID" value="ID"> RLG&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--->
  ...
  <input type="radio" name="nombre" value="nombre"> Nombre &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--tabla 2 --->
<table>
<form action="http://192.168.39.31/intranet/images/RegistroCivil/acta/actas_excel.php" method="post">
<tr>
<th align="center">
<!--- <input type="radio" name="ID" value="ID"> RLG&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--->
  <input type="radio" name="folio" value="folio"> Folio &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
